...
const productData = [

    {
        ...
        metaTitle: "Digital Kiosk Display | Kiosk Machine Dubai | Electronic Digital Display Supplier",
        metaDescription: "Pixel World is a trusted supplier of digital kiosk displays, kiosk machines, and electronic digital displays in Dubai. Call now for premium products and services!",
        ...
        description: " Pixelworld offers a range of versatile digital kiosks, available in sizes from 43 to 86 inches, ensuring a perfect fit for any space, whether it's a compact kiosk for a small lobby or a large display for a busy mall. Our interactive touch screen kiosks are ideal for high-traffic environments like clubs and information centers, providing users with easy, direct access to information. With customizable options for Android or Windows operating systems, our kiosks integrate seamlessly with your existing systems. We offer both indoor and outdoor models, with outdoor kiosks built to endure various weather conditions for reliable performance year-round. PixelPlus kiosks enhance user engagement, are durable, and offer flexible, tailored solutions to suit your needs, making them perfect for malls, lobbies, clubs, and other high-traffic areas. Contact us today to explore how our high-quality kiosks can benefit your business.",
        products: [
            {
                title: `43" Portable Advertising Display`,
                description: ` A 43" Portable Advertising Display is a versatile and dynamic advertising solution designed for easy portability, ideal for businesses that need to showcase promotional content or information on-the-go. Its compact size allows it to fit in a variety of spaces, and it can be moved effortlessly between locations. This display is perfect for retail stores, trade shows, pop-up events, or exhibitions where a powerful visual impact is necessary. The system features an integrated design with a lightweight body, auto coloring and image enhancement, multiple play modes, and the ability to manage and control one or more screens remotely, including startup and shutdown scheduling. Technical specifications include a 43-inch Full HD screen (1920x1080 resolution), 300-500 nits of brightness for clear visibility even in bright environments, and multiple connectivity options such as Wi-Fi, USB, and HDMI. The display runs on Android or Windows OS, with built-in speakers and can be powered via AC or battery. Usage: Retail stores, trade shows, events, and exhibitions for showcasing ads, product demos, and promotions.`
            },
            {
                title: ` 55" Portable Advertising Display`,
                description: `The 55" Portable Advertising Display offers a larger screen for greater visibility and impact, making it ideal for busy retail environments, public events, or digital signage applications. It provides an immersive experience with high-definition visuals, perfect for promoting products, services, or engaging with customers. This display offers a Full HD resolution, 350-500 nits brightness for clear outdoor viewing, and supports various connectivity options such as Wi-Fi, Bluetooth, USB, and HDMI. With a lightweight design and built-in speakers, it can be easily moved and set up. Technical specifications include a 55-inch Full HD screen, Android or Windows OS, with options for wall mounting or stand-alone installation.Usage: Shopping malls, retail stores, exhibitions, airports, and trade shows for advertisements, promotions, and digital signage.`
            },
            {
                title: `49" Floor Standing Touch Kiosk`,
                description: `The 49" Floor Standing Touch Kiosk is a sleek and interactive display solution for businesses that need a self-service station for customers to engage with. It can be used for wayfinding, product information, or order placement. The kiosk features a 49-inch touchscreen that provides an intuitive, user-friendly experience. Its high-definition resolution (1920x1080) ensures clear, vibrant visuals, while its touch capabilities allow users to interact directly with the content. Technical specifications include a 49-inch screen, Android or Windows OS, 300-500 nits brightness, and connectivity options like USB, HDMI, and Ethernet for remote updates. It is ideal for both indoor and outdoor settings. Usage: Shopping malls, airports, museums, restaurants, and corporate offices for self-service, interactive directories, and information sharing.`
            },
            {
                title: `55" Floor Standing Touch Kiosk (4K)`,
                description: ` The 55" Floor Standing Touch Kiosk (4K) is a high-definition, large-format interactive display designed to offer a premium experience for customers. With a 4K resolution (3840x2160), it delivers stunningly clear and sharp visuals, making it ideal for high-end retail, exhibitions, and events where clear content display and interactivity are key. Its touchscreen feature allows customers to interact directly with the screen, providing an engaging user experience. Technical specifications include a 55-inch 4K screen, capacitive touchscreen technology, Android or Windows OS, 500 nits brightness for high visibility, and connectivity options like Wi-Fi, Bluetooth, and USB. Usage: Luxury retail stores, museums, trade shows, and high-traffic public spaces for interactive product displays, promotional content, and customer engagement.`
            },
            {
                title: ` 65" Floor Standing Touch Kiosk (4K)`,
                description: ` The 65" Floor Standing Touch Kiosk (4K) offers an even larger screen, making it perfect for high-traffic areas where visibility and interaction are critical. The 4K resolution ensures that every detail is visible, and the larger screen size allows for engaging multimedia presentations, digital signage, and self-service options. With touch capabilities, it enables users to interact with the displayed content, whether it's for information gathering, browsing, or placing orders. Technical specifications include a 65-inch 4K display, Android or Windows OS, capacitive touchscreen, 500 nits brightness, and connectivity through HDMI, USB, and Wi-Fi. Usage: Airports, shopping malls, exhibitions, conference centers, and restaurants for wayfinding, product information, digital signage, and customer interactions.`
            },
            {
                title: ` 70" Floor Standing Full Screen Advertising Display `,
                description: `The 70" Floor Standing Full Screen Advertising Display is a high-impact digital signage solution designed for maximum visibility. With a huge 70-inch screen, it’s ideal for outdoor or indoor environments with heavy foot traffic where capturing attention is essential. The large size and high resolution (1920x1080) ensure vibrant, clear, and engaging content. Technical specifications include a 70-inch screen, Full HD resolution, 500-700 nits brightness, and multiple connectivity options like Wi-Fi, USB, and HDMI. This screen can be used for advertisements, product promotions, and wayfinding in areas such as shopping malls, airports, and transit stations. Usage: Outdoor events, shopping malls, train stations, and airports for advertising, promotions, and real-time updates.`
            },
            {
    ...
    },
    {
        image:Product2,
        title: "LED Screens",
        metaTitle: "LED Screen | Outdoor LED Screen Supplier in Dubai | LED Display Screen Supplier",
        metaDescription: "Pixel World, a trusted LED screen supplier in Dubai, offers outdoor LED screens, LED display screens, and more. Call now for premium LED screen solutions!",
    ...
    }, 
    {
        ...
        metaDescription:"Pixel World, leading LED light suppliers in Dubai, offers premium-quality LED lights for all your lighting needs. Call now to get the best LED solutions in Dubai!",
    ...
    },
     {
        image:Product4,
        title: "LED Supplies",
        metaTitle:"Pixel World LED Lightings – LED Screen Components & Installation",
        metaDescription: "Pixel World provides LED screen components, display control cards, outdoor LED screen installation, and LED video processors. Call now for top-quality solutions!",
        ...
        description: " LED components are crucial for the performance and efficiency of LED screens, lighting systems, and digital kiosks. Control cards, power supplies, and video processors regulate display quality, brightness, and energy usage. In LED screens, modules and pixel LEDs determine resolution and color accuracy, ensuring vibrant visuals for billboards or signage. For LED lighting, components enable customizable brightness and color, enhancing effects in retail or architectural designs. In digital kiosks, media players and touch sensors enable interactive content. These components are essential for the smooth, reliable operation of LED technologies across industries like advertising, retail, and public information.",
        products: [
            {
                title: " LED Screen Control Cards",
                description: " LED screen control cards are essential components for managing the operation of LED displays. These cards convert the input video signal into a format compatible with the LED screen, controlling image display, brightness, and color. Used in large-scale LED video walls, outdoor billboards, and advertising screens, they enable precise control over the content displayed. Advantages include improved content synchronization, high performance, and flexibility in display settings."
            },
            {
                title: " Media Player for LED Screen",
                description: " A media player for LED screens is a device that stores and manages multimedia content, such as videos, images, and presentations, and then plays them on an LED display. Media players are typically used in digital signage, advertising, retail displays, and trade shows. Advantages include ease of content scheduling, seamless playback, and compatibility with various media formats."
            },
            {
                title: " Video Processor",
                description: " A video processor is used to process and convert high-definition video signals to match the LED display's specifications. It adjusts the resolution, color, brightness, and contrast for optimal performance. Video processors are commonly used in control rooms, large venues, broadcast setups, and digital signage. Advantages include superior image quality, signal enhancement, and multi-screen display management."
            },
            {
                title: " Sending Card ",
                description: " A sending card is a device used to transmit the video signal from the media source (such as a computer or server) to the LED screen. It ensures that the content is accurately displayed on the LED screen by distributing the signal to the receiving cards. Applications include digital billboards, retail displays, and exhibition installations. Advantages include smooth signal transmission and compatibility with various input sources."
            },
            {
                title: " LED Screen Repairing and Maintenance",
                description: " LED screen repairing and maintenance involves troubleshooting, diagnosing issues, and performing repairs on malfunctioning LED screens. This process includes replacing faulty LEDs, control cards, and wiring. Regular maintenance is crucial for ensuring the longevity and performance of screens used in high-traffic environments such as shopping malls, airports, and event venues. Advantages include prolonging the lifespan of the screens and maintaining content quality."
            },
            {
                title: " LED Cabinet",
                description: " An LED cabinet is a housing unit that contains the LED modules, power supply, and control system for an LED screen. These cabinets are modular, allowing for scalable, customizable display setups. Applications include large-scale video walls, outdoor advertising, and sports arenas. Advantages include durability, ease of maintenance, and the ability to replace modules individually."
            },
            {
                title: " Pixel LED",
